(function() {
    ...
    zargetMain = zargetMain || (function() {
                            ...
                            : function(e, t, n) {
                                ...
                                if (c) {
                                    ...
                                    m && p) {
                                        ...
                                        if (p && (d = s = (r = (i = (o = (a = e)[S] || (a[S] = {}))[a.uniqueID] || (o[a.uniqueID] = {}))[h] || [])[0] === k && r[1]),
                                        !1 === d) {
                                            while (a = ++s && a && a[l] || (d = s = 0) || u.pop()) {
        ...
        var Zarget = (function() {
            var zarget = {}, document = window.document, navigator = window.navigator, CssSelector, _cachedformlabels = {}, timeOutVariable;
            ...
            function getClassName(node, excludes) {
                ...
                var classes = node.getAttribute("class"), claz;
                var v;
                if (classes) {
                    v = "";
            ...
            function getId(node, excludes) {
                ...
                var elementid = node.getAttribute("id"), regex, ps;
                if (elementid) {
            ...
            CssSelector = {
                cssPath: function(node, optimized, excludes) {
                    ...
                    var steps = [], contextNode = node, step;
                    while (contextNode) {
                ...
                cssPathStep: function(node, optimized, isTargetNode, excludes) {
                    ...
                    var id = getId(node, excludes), nodeNameLower, nodeName, parent, prefixedOwnClassNamesArray, needsClassNames, needsNthChild, ownIndex, elementIndex, siblings, i, sibling, ownClassNames, ownClassNameCount, name, siblingClassNamesArray, j, siblingClass, result, prefixedName;
                    if (optimized) {
                        if (id) {
            ...
            zarget.parseJSON = function(data) {
                ...
                var rvalidtokens = /(,)|(\[|{)|(}|])|"(?:[^"\\\r\n]|\\["\\\/bfnrt]|\\u[\da-fA-F]{4})*"\s*:?|true|false|null|-?(?!0\d)\d+(?:\.\d+|)(?:[eE][+-]?\d+|)/g, requiredNonComma, depth = null, str = zarget.trim(data + "");
            ...
            zarget.getCookies = function() {
                ...
                var cookies = {}, cookie, cname, cval, dcookies, i, l, oldCookieName = "freshworks-s360-vid";
                dcookies = document.cookie.split(";");
                for (i = 0,
                l = dcookies.length; i < l; i++) {
                    cookie = dcookies[i];
            ...
            zarget.rememberGoal = function(exp, goalid) {
                ...
                var age = 365 * 24 * 60 * 60 * 1000, goalInfo = Zarget.getGoalInfo(), gobj;
            ...
            zarget.isExperimentURLMatches = function(e) {
                ...
                var EXPERIMENT = {
                    ...
                    FORMS: 7,
                    SESSIONREPLAY: 8
                }, urls = e.urls, excludes = e.excludeUrls, i, j, l, jl, url, u, v, variations = e.variations;
                if (!urls) {
                    return
                }
                var exp = false;
            ...
            zarget.Messenger = {
                _getApiURL: function(type) {
                    var serverurl = zarget.serverinfo.serverurl, apiurl;
                    switch (type) {
            ...
            zarget.isSecureField = function(node) {
                ...
                var form = window.zarget$(node).parents("form"), labels, fieldlabel, c;
        ...
        (function(Zarget) {
            ...
            UserAgent.prototype = {
                ...
                getDevice: function() {
                    var ua = this.useragent.toLowerCase(), i, l;
                    for (i = 0,
                    l = devices.length; i < l; i++) {
                ...
                getBrowser: function() {
                    var ua = this.useragent, i, l;
                    for (i = 0,
                    l = browsers.length; i < l; i++) {
            ...
            Targeting.prototype = {
                ...
                location: function(c) {
                    ...
                    for (i = 0,
                    l = targetingLocations.length; i < l; i++) {
                        loc = targetingLocations[i],
                        a = loc.text.split(", ");
                        if (!a || !a.length) {
                            continue
                        }
                ...
                testConditionGroup: function(conditiongroup) {
                    ...
                    var conditions = conditiongroup.conditions, conditiontype = parseInt(conditiongroup.type, 10), i, l, condition, t, matches, flag;
                    if (!conditions || !(conditions instanceof Array) || conditions.length === 0) {
                        return true
                    }
        ...
        var ZargetData = {
            ...
            integrations: {},
            goals: {},
            orgidhash: "4256515955565C475C565958434C575D575E5E5D58"
        };
        var zgAddHeatmapLoader = function() {
            ...
            if (!loader) {
                var d = document.createElement("div"), style, intervalid, html;
        ...
        (function(Zarget, ZargetData) {
            ...
            function trimZargetParams(hash) {
                var hashStr = "", params, hasZgParams, i, param, name, value;
                params = hash.split("&");
                hasZgParams = false;
                for (i = 0,
                param,
                name,
                value; i < params.length; i++) {
                    param = params[i];
            ...
            function getOriginURL() {
                var url = document.URL, a, hash, search, origin;
            ...
            function getHashParamValue(name) {
                name = name.replace(/[\[\]]/g, "\\$&");
                var hash = window.location.hash, rgx = new RegExp("[#&]" + name + "(=([^&#]*)|&|#|$)"), results;
        ...
        (function(Zarget, ZargetData) {
            ...
            var isPrevMode, prevModeExperiment, prevAppliedvarName, segmentMsgQueue = [], segPageVisitMsg = {};
            ...
            function hasCrossDomainExperiments() {
                ...
                var experiments = ZargetData.experiments, experiment, expid;
            ...
            var GOAL_TYPES = {
                ...
                POLLS: 6,
                FORM: 7
            }, serverurl = Zarget.serverinfo.serverurl, returningVisitorUrl = Zarget.serverinfo.returningVisitorUrl, visitorUrl = Zarget.serverinfo.visitorUrl, executioncompleted = false, goalUrl = Zarget.serverinfo.goalUrl, experiment, process = false, experiments = [];
            ...
            function sendCustomEventGoal(eventName, goalType, revenue) {
                ...
                var allGoals, i, g, l, urls, j, l1, url, cururl, matches, simplematch_conditions = [1, 2, 3, 4], exp;
            ...
            Experiment.prototype = {
                ...
                sendVisitorInfo: function(returning, rv) {
                    var visitorinfo = Zarget.getVisitorInfo(), img, experiment = this.experiment, expid = experiment.id, lid = experiment.lid, varid, r, uid, url, referrer, type, msg;
                ...
                checkAllVariationChangesMarked: function(expData) {
                    ...
                    if (variation && variation.changes && Array.isArray(variation.changes)) {
                        var counter = 0;
                        for (i = 0,
                        l = variation.changes.length; i < l; i++) {
                ...
                getVariation: function(id) {
                    var i, l;
                    for (i = 0,
                    l = this.experiment.variations.length; i < l; i++) {
                ...
                getVistedUserVariationInfo: function() {
                    var visitorinfo = Zarget.getVisitorInfo(), variation;
                ...
                abtest: function(variation) {
                    ...
                    var changes = variation.changes, i, l;
                    for (i = 0,
                ...
                abtestpolling: function() {
                    var variation = this.getAppliedVariation(), changes, change, i, l;
                ...
                spliturl: function(variation) {
                    ...
                    if (experiment.regex) {
                        ...
                        orig = orig.replace(/([\[\]\(\)\*\^\$\.\?\|\/\\])/g, "\\$1");
                        var groupPatt = /(\\\(([^\)\/]*)\))/g;
                        var match1 = orig.match(groupPatt), grpMatch;
                        var orig1 = "";
                        if (orig.match(groupPatt) !== null) {
                            var d = 0;
                            var lastInd = 0;
                        ...
                        var match = locHref.match(strEx), matcher;
                        if (match !== null && match.index === 0 && match[0].length == locHref.length) {
                            found = true;
                            checkURL = match[0]
                        } else {
                ...
                sendGoal: function(goal) {
                    var visitorinfo = Zarget.getVisitorInfo(), img, expid, lid, varid, gid, r, uid, msg, url, referrer, rc;
                    if (!visitorinfo) {
                        return
                    }
                    var goalInfo = Zarget.getGoalInfo();
                ...
                rememberVisitor: function(variationid, personalization) {
                    ...
                    var age = 365 * 24 * 60 * 60 * 1000, visitorinfo = Zarget.getVisitorInfo(), vobj;
            ...
            function setExperimentsInCookie(masterCookie) {
                var age = 365 * 24 * 60 * 60 * 1000, visitorinfo = Zarget.getVisitorInfo(), i, vobj = typeof visitorinfo === "object" ? visitorinfo : {};
                var experiments;
                try {
            ...
            function trackGoal(evt) {
                var goals = experiments.filterGoal(evt), e$, ele, tag, r, r1, i, l, goal, type, experiment;
            ...
            function processCrossDomainExperiment(masterCookie, exp) {
                var age = 365 * 24 * 60 * 60 * 1000, visitorinfo = Zarget.getVisitorInfo(), variation;
            ...
            function applyAbPreview(prevModeVariationChanges) {
                ...
                if (prevModeVariationChanges) {
                    var i, l;
                    for (i = 0,
                    l = prevModeVariationChanges.length; i < l; i++) {
            ...
            function triggerExpById(expId) {
                var visitorinfo = Zarget.getVisitorInfo(), expDet;
                for (var exp in visitorinfo) {
        ...
        (function(Zarget, ZargetData) {
            ...
            if (Zarget.isReportView && Zarget.isReportView()) {
                var hashParams = Zarget.isPausedExp(), orgid, expid, expHashId, varid, expInfo, segName, segType;
                if (hashParams) {
            ...
            Zarget.offset = function(elem) {
                var docElem, win, box = {
                    top: 0,
                    left: 0
                }, doc = elem && elem.ownerDocument, strundefined = typeof undefined;
                if (!doc) {
                    return
                }
                ...
                handlers: {
                    click: function(evt) {
                        try {
                            ...
                            var el, o, x, y, s, px, py, r, b, msg, uid, expid, vid, ttc, url, sch, lid, ety, lang = Zarget.getUserLanguage(), loadt = Zarget.getPageLoadTime(), res = Zarget.getScreenResolution(), referrer;
            ...
            function sendVisitorInfo(exp, returning, rv) {
                var experiment = exp.experiment;
                var visitorinfo = Zarget.getVisitorInfo(), img, expid = experiment.id, lid = experiment.lid, varid, r, uid, url, referrer, type, msg, lang = Zarget.getUserLanguage(), loadt = Zarget.getPageLoadTime(), res = Zarget.getScreenResolution();
                if (!visitorinfo || !visitorinfo.hasOwnProperty(lid)) {
                    return
                }
                url = encodeURIComponent(document.URL);
            ...
            var ZargetScroll = {
                ...
                getScrollLimit: function(expid) {
                    ...
                    var key = this.getScrollLimitKey(expid), visitorInfo;
                ...
                sendScrollInfo: function(e) {
                    var visitorinfo = Zarget.getVisitorInfo(), img, varid, expid, lid, r, uid, url, type, msg, y1, y2, lang = Zarget.getUserLanguage(), loadt = Zarget.getPageLoadTime(), res = Zarget.getScreenResolution(), referrer;
            ...
            function onDOMReady() {
                ...
                var userid = Zarget.getUidAndSetIfNotExists();
                for (var i = 0, exp; exp = experiments[i]; i++) {
                    var visitorInfo = Zarget.getVisitorInfo(), expid = exp.experiment.id, lid = exp.experiment.lid, variationID = visitorInfo ? visitorInfo[lid] : undefined, traffic, runExperiment, isReturningUser = visitorInfo && visitorInfo.hasOwnProperty(lid);
                    if (variationID === -1) {
                        continue
                    }
        ...
        (function(Zarget, ZargetData) {
            ...
            Zarget.Funnel.prototype = {
                callPendingExperiments: function(cookieObj, otherParams) {
                    ...
                    for (i = 0,
                    l = pendingExperiments.length; i < l; i++) {
                ...
                start: function(customevent) {
                    var runningFunnels = this.findMatchingFunnels(customevent), i, l;
                ...
                findMatchingFunnels: function(customevent) {
                    var curUrl, i, hasTrailingSlash, urlsToMatch, j, filteredFunnels = [], url, matches, spec;
                    if (!this.experiments) {
                        return
                    }
                ...
                sendMessage: function(experiment, virtualpage) {
                    var expid = experiment.id, r, uid, url, referrer, type, msg, lang = Zarget.getUserLanguage(), loadt = Zarget.getPageLoadTime(), res = Zarget.getScreenResolution();
                    url = encodeURIComponent(document.URL);
                    referrer = document.referrer;
                    if (experiment.isCrossDomainExperiment) {
                        uid = window.zarget_masteruserid
            ...
            (function start() {
                ...
                var experiment, e, experiments = [], funnel;
        ...
        (function(Zarget, ZargetData) {
            ...
            function sendVisitorInfo(returning, status, geoData, rv) {
                var visitorinfo = Zarget.getPollsInfo(), img, fid = poll.id, r, uid, url, referrer, type, msg;
            ...
            function sendFieldData(field, answer, status, skipped) {
                var visitorinfo = Zarget.getPollsInfo(), img, fid, varid, r, uid, msg, url, referrer;
                if (!visitorinfo) {
                    return
                }
                url = encodeURIComponent(document.URL);
            ...
            function rememberPoll() {
                var visitorinfo = Zarget.getPollsInfo(), vobj;
                vobj = typeof visitorinfo === "object" ? visitorinfo : {};
    ...
    (function(url, appToken, formCapture) {
        ...
        if (window.freshsales.salesData.length == 0) {
            ...
            freshsales.salesData.init("https://staging-test-prabhu.myfreshworks.dev/crm/sales", "5be9faa4e63bdc0aa0bb00d18d1817a48640bdd217f7d5c61a05c7412b485d6c", true, 8281127, "https://fm-staging-us-app-cdnjs.s3.amazonaws.com/crm", {
                enabled: true
            })
        }
    }
    ...
    var session_fetch = (function(win, doc, nav) {
        ...
        var SessionRunner = function() {
            ...
            var asynchs = 0, module, result, check_asynch = function(deinc) {
                if (deinc) {
                    asynchs--
                }
                if (asynchs === 0) {
            ...
            session: function(cookie, expires) {
                ...
                if (session == null) {
                    ...
                    var search_engines = [{
                        ...
                        host: "baidu.com",
                        query: "wd"
                    }], length = search_engines.length, engine, match, i = 0, fallbacks = "q query term p wd query text".split(" ");
                    for (i = 0; i < length; i++) {
        ...
        var util = {
            parse_url: function(url_str) {
                ...
                if (query_str != "") {
                    var pairs = query_str.split("&"), i = 0, length = pairs.length, parts;
                    for (; i < length; i++) {
                        parts = pairs[i].split("=");
                        if (parts.length === 2) {
        ...
        var JSON = {
            ...
            stringify: (win.JSON && win.JSON.stringify) || function(object) {
                ...
                if (type !== "object" || object === null) {
                    ...
                    var k, v, json = [], isArray = (object && object.constructor === Array);
                    for (k in object) {
                        v = object[k];
                        type = typeof v;
                        if (type === "string") {
    ...
    function initFreshChat() {
        window.fcWidget.init({
            ...
            token: "34d55a41-ce1a-406b-9084-7a56fb177e94",
            host: "https://staging-test-prabhu-8f7185d8fa71ca617003651.freshpori.com"
        })
    }
    function initialize(i, t) {
        ...
        e.async = !0,
        e.src = "https://staging-test-prabhu-8f7185d8fa71ca617003651.freshpori.com/js/widget.js",
